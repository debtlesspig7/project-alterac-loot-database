...
---- Azuregos
	...
	AtlasLoot_Data["ShadowfangKeep1"] = {
		...
		{ 4, 700134, "", "=q3=Haunting Blade (Heroic)", "=ds=#h2#, #w10#", "", "Heroic"};
		{ 6, 0, "INV_Box_01", "=q6="..AL["Rethilgore"], ""};
		{ 7, 5254, "", "=q3=Rugged Spaulders", "=ds=#s3#, #a2#", "", "84.73%"};
		{ 9, 0, "INV_Box_01", "=q6="..AL["Felsteed"], ""};
		{ 10, 6341, "", "=q3=Eerie Stable Lantern", "=ds=#s15#", "", "5.48%"};
		{ 11, 700138, "", "=q3=Eerie Stable Lantern (Heroic)", "=ds=#s15#", "", "Heroic"};
		{ 12, 932, "", "=q1=Fel Steed Saddlebags", "=ds=#m12# #e1#", "", "16.46%"};
		...
		{ 19, 700135, "", "=q3=Butcher's Slicer (Heroic)", "=ds=#h1#, #w10#", "", "Heroic"};
		{ 20, 1292, "", "=q3=Butcher's Cleaver", "=ds=#h1#, #w1#", "", "8.70%"};
		{ 21, 700136, "", "=q3=Butcher's Cleaver (Heroic)", "=ds=#h1#, #w1#", "", "Heroic"};
		{ 23, 0, "INV_Box_01", "=q6="..BabbleBoss["Baron Silverlaine"], ""};
		{ 24, 6321, "", "=q3=Silverlaine's Family Seal", "=ds=#s13#", "", "18.91%"};
		{ 25, 6323, "", "=q3=Baron's Scepter", "=ds=#h1#, #w6#", "", "37.93%"};
		{ 26, 700105, "", "=q3=Baron's Scepter (Heroic)", "=ds=#h1#, #w6#", "", "Heroic"};
		Next = "ShadowfangKeep2";
	};
	
	AtlasLoot_Data["ShadowfangKeep2"] = {
		{ 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Commander Springvale"], ""};
		{ 2, 3191, "", "=q3=Arced War Axe", "=ds=#h2#, #w1#", "", "31.73%"};
		{ 3, 700103, "", "=q3=Arced War Axe (Heroic)", "=ds=#h2#, #w1#", "", "Heroic"};
		{ 4, 6320, "", "=q3=Commander's Crest", "=ds=#w8#", "", "27.71%"};
		{ 5, 700137, "", "=q3=Commander's Crest (Heroic)", "=ds=#w8#", "", "Heroic"};
		{ 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Odo the Blindwatcher"], ""};
		{ 8, 6319, "", "=q3=Girdle of the Blindwatcher", "=ds=#s10#, #a2#", "", "57.15%"};
		{ 9, 6318, "", "=q3=Odo's Ley Staff", "=ds=#w9#", "", "29.97%"};
		{ 10, 700139, "", "=q3=Odo's Ley Staff (Heroic)", "=ds=#w9#", "", "Heroic"};
		{ 12, 0, "INV_Box_01", "=q6="..BabbleBoss["Fenrus the Devourer"], ""};
		{ 13, 6340, "", "=q3=Fenrus' Hide", "=ds=#s4#", "", "58.02%"};
		{ 14, 3230, "", "=q3=Black Wolf Bracers", "=ds=#s8#, #a2#", "", "14.76%"};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Arugal's Voidwalker"], ""};
		{ 17, 5943, "", "=q3=Rift Bracers", "=ds=#s8#, #a3#", "", "3%"};
		{ 19, 0, "INV_Box_01", "=q6="..BabbleBoss["Wolf Master Nandos"], ""};
		{ 20, 6314, "", "=q3=Wolfmaster Cape", "=ds=#s4#", "", "33.25%"};
		{ 21, 3748, "", "=q3=Feline Mantle", "=ds=#s3#, #a1#", "", "48.55%"};
	...
	AtlasLoot_Data["ShadowfangKeep3"] = {
		...
		{ 2, 6324, "", "=q3=Robes of Arugal", "=ds=#s5#, #a1#", "", "30.50%"};
		{ 3, 700140, "", "=q3=Robes of Arugal (Heroic)", "=ds=#s5#, #a1#", "", "Heroic"};
		{ 4, 6392, "", "=q3=Belt of Arugal", "=ds=#s10#, #a1#", "", "30.51%"};
		{ 5, 6220, "", "=q3=Meteor Shard", "=ds=#h1#, #w4#", "", "15.78%"};
		{ 7, 24224, "", "=q1=Crate of Bloodforged Ingots", "=ds=#m3#"};
		{ 8, 6895, "", "=q1=Jordan's Smithing Hammer", "=ds=#m3#"};
		{ 9, 6283, "", "=q1=The Book of Ur", "=ds=#m3#"};
		{ 16, 0, "INV_Box_01", "=q6="..AL["Trash Mobs"], ""};
	...
	AtlasLoot_Data["TheDeadmines1"] = {
		...
		{ 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Rhahk'Zor"], ""};
		{ 10, 872, "", "=q3=Rockslicer", "=ds=#h2#, #w1#", "", "3.13%"};
		{ 11, 700122, "", "=q3=Rockslicer (Heroic)", "=ds=#h2#, #w1#", "", "Heroic"};
		{ 12, 5187, "", "=q3=Rhahk'Zor's Hammer", "=ds=#h2#, #w6#", "", "77.98%"};
		{ 13, 700124, "", "=q3=Rhahk'Zor's Hammer (Heroic)", "=ds=#h2#, #w6#", "", "Heroic"};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Miner Johnson"], ""};
		{ 17, 5444, "", "=q3=Miner's Cape", "=ds=#s4#", "", "54.88%"};
		{ 18, 5443, "", "=q3=Gold-plated Buckler", "=ds=#w8#", "", "37.21%"};
		{ 19, 700106, "", "=q3=Gold-plated Buckler (Heroic)", "=ds=#w8#", "", "Heroic"};
		{ 20, 0, "INV_Box_01", "=q6="..BabbleBoss["Sneed's Shredder"], ""};
		{ 21, 2169, "", "=q3=Buzzer Blade", "=ds=#h1#, #w4#", "", "70.78%"};
		{ 22, 700108, "", "=q3=Buzzer Blade (Heroic)", "=ds=#h1#, #w4#", "", "Heroic"};
		{ 23, 1937, "", "=q3=Buzz Saw", "=ds=#h1#, #w10#", "", "8.75%"};
		{ 24, 7365, "", "=q1=Gnoam Sprecklesprocket", "=ds=#m3#", "", "100%"};
		{ 25, 0, "INV_Box_01", "=q6="..BabbleBoss["Sneed"], ""};
		{ 26, 5195, "", "=q3=Gold-flecked Gloves", "=ds=#s9#, #a1#", "", "62.38%"};
		{ 27, 5194, "", "=q3=Taskmaster Axe", "=ds=#h2#, #w1#", "", "26.23%"};
		{ 28, 700123, "", "=q3=Taskmaster Axe (Heroic)", "=ds=#h2#, #w1#", "", "Heroic"};
		{ 29, 5397, "", "=q1=Defias Gunpowder", "=ds=#m3#", "", "100%"};
		Next = "TheDeadmines2";
	};
	...
	AtlasLoot_Data["TheDeadmines2"] = {
		...
		{ 4, 0, "INV_Box_01", "=q6=#n7#", ""};
		{ 5, 10403, "", "=q3=Blackened Defias Belt", "=ds=#s10#, #a2#", "", "23.26%"};
		{ 6, 5200, "", "=q3=Impaling Harpoon", "=ds=#w7#", "", "25.39%"};
		{ 7, 700121, "", "=q3=Impaling Harpoon (Heroic)", "=ds=#w7#", "", "Heroic"};
		{ 8, 5201, "", "=q3=Emberstone Staff", "=ds=#w9#", "", "34.10%"};
		{ 9, 700127, "", "=q3=Emberstone Staff (Heroic)", "=ds=#w9#", "", "Heroic"};
		{ 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Mr. Smite"], ""};
		{ 11, 5192, "", "=q3=Thief's Blade", "=ds=#h1#, #w10#", "", "34.96%"};
		{ 12, 700125, "", "=q3=Thief's Blade (Heroic)", "=ds=#h1#, #w10#", "", "Heroic"};
		{ 13, 5196, "", "=q3=Smite's Reaver", "=ds=#h1#, #w1#", "", "33.95%"};
		{ 14, 700126, "", "=q3=Smite's Reaver (Heroic)", "=ds=#h1#, #w1#", "", "Heroic"};
		{ 15, 7230, "", "=q3=Smite's Mighty Hammer", "=ds=#h2#, #w6#", "", "17.27%"};
		{ 16, 700100, "", "=q3=Smite's Mighty Hammer (Heroic)", "=ds=#h2#, #w6#", "", "Heroic"};
		{ 17, 0, "INV_Box_01", "=q6="..BabbleBoss["Cookie"], ""};
		{ 18, 5197, "", "=q3=Cookie's Tenderizer", "=ds=#h1#, #w6#", "", "49.62%"};
		{ 19, 700128, "", "=q3=Cookie's Tenderizer (Heroic)", "=ds=#h1#, #w6#", "", "Heroic"};
		{ 20, 5198, "", "=q3=Cookie's Stirring Rod", "=ds=#w12#", "", "30.90%"};
		{ 21, 700107, "", "=q3=Cookie's Stirring Rod (Heroic)", "=ds=#w12#", "", "Heroic"};
		{ 22, 8490, "", "=q1=Cat Carrier (Siamese)", "=ds=#e13#", "", "12.38%"};
		{ 23, 0, "INV_Box_01", "=q6=#n6#", ""};
		{ 24, 5193, "", "=q3=Cape of the Brotherhood", "=ds=#s4#", "", "21.25%"};
		{ 25, 5202, "", "=q3=Corsair's Overshirt", "=ds=#s5#, #a1#", "", "22.86%"};
		{ 26, 10399, "", "=q3=Blackened Defias Armor", "=ds=#s5#, #a2#", "", "14.77%"};
		{ 27, 5191, "", "=q3=Cruel Barb", "=ds=#h1#, #w10#", "", "14.17%"};
		{ 28, 700104, "", "=q3=Cruel Barb (Heroic)", "=ds=#h1#, #w10#", "", "Heroic"};
		{ 29, 2874, "", "=q1=An Unsent Letter", "=ds=#m2#"};
		{ 30, 3637, "", "=q1=Head of VanCleef", "=ds=#m3#"};
		Prev = "TheDeadmines1";
		Next = "VWOWSets1";
	};
